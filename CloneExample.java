...
=======
        {
            ...
            System.out.println();
            System.out.println();
            System.out.println("list: " + listDeepCopy2);

            //this is where it is going wrong
            System.out.println(listDeepCopy2.remove(0));
            System.out.println();
            System.out.println();
            System.out.println();
            System.out.println(listDeepCopy2.size());
            System.out.println(listDeepCopy2);
            //listDeepCopy2.clear();
            //System.out.println("size: " + listDeepCopy2.size());

        }
>>>>>>> 629e2cd380b24f25474d6eff6556b84d7127b468
}
